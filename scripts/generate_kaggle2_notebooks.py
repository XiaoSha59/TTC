...
out_dir = r"d:\TTC\kaggle_account_2"
os.makedirs(out_dir, exist_ok=True)

# -------------------------------------------------------------
# Common cells generator
# -------------------------------------------------------------
def get_setup_cells(title_md):
    return [
        {
            "cell_type": "markdown",
            "metadata": {},
...
# -------------------------------------------------------------
# NOTEBOOK 1: 50:50 Sup Minority (Ours)
# -------------------------------------------------------------
nb1_cells = get_setup_cells("🐝 TTC: Insects 50:50 SupMinority (Ours) [Table 1]") + [
    {
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
...
with open(os.path.join(out_dir, "kaggle2_gpu1_supmin_50_50.ipynb"), "w", encoding="utf-8") as f:
    json.dump(nb1, f, indent=2, ensure_ascii=False)


# -------------------------------------------------------------
# NOTEBOOK 2: 50:50 Standard SupCon & 99:1 Standard SupCon
# -------------------------------------------------------------
nb2_cells = get_setup_cells("🐝 TTC: Insects Standard SupCon (50:50 & 99:1) [Table 1]") + [
    {
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
...
with open(os.path.join(out_dir, "kaggle2_gpu2_supcon_50_50_and_99_1.ipynb"), "w", encoding="utf-8") as f:
    json.dump(nb2, f, indent=2, ensure_ascii=False)

print("Generated both standalone notebooks for Kaggle Account 2!")
