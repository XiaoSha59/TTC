...
echo "=================================================================="
echo "🚀 RUNNING SUPCON 50:50 (Target: 93.3% Balanced Accuracy)"
echo " Data: ${INAT21_DATA_PATH}"
echo "=================================================================="

echo ">>> [STAGE 1/2] Pretraining (350 Epochs, SupCon 50:50)..."
python3 train.py \
...
TARGET_CKPT="${BASE_DIR}/logs/insects_50_50_supcon_full_pretrain_last.ckpt"
...
python3 train.py \
    ...
    name="insects-50_50-supcon-full-probe"

echo "🎉 SUPCON 50:50 COMPLETED SUCCESSFULLY at $(date)!"
