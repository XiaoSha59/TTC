#!/bin/bash
# ==============================================================================
# Run Official Linear Probing (Fine-tune) for Animals (Table 1)
...
echo "=========================================================="
echo " Starting Official Paper Fine-tune Probing: ANIMALS"
...
MODELS=(
    "animals-50_50-supproto"
    "animals-50_50-supmin"
    "animals-50_50-supcon"
    "animals-95_5-supproto"
    "animals-95_5-supmin"
    "animals-95_5-supcon"
    "animals-99_1-supproto"
    "animals-99_1-supmin"
    "animals-99_1-supcon"
)
...
" "finetune-$RUN_NAME")
    ...
    python train.py experiment=finetune experiment/specs=animals \
...
echo ""
echo "=========================================================="
echo "✅ All Animals Fine-tuning Completed!"
echo "=========================================================="
