...
echo "=================================================================="
echo "🚀 RUNNING SUPCON 95:5 (Target: 81.6% Balanced Accuracy)"
echo " Data: ${INAT21_DATA_PATH}"
echo "=================================================================="

echo ">>> [STAGE 1/2] Pretraining (350 Epochs, SupCon 95:5)..."
python3 train.py \
...
TARGET_CKPT="${BASE_DIR}/logs/insects_95_5_supcon_full_pretrain_last.ckpt"
...
echo "🎉 SUPCON 95:5 COMPLETED SUCCESSFULLY at $(date)!"
